...
# this function takes speech from user and return string text
...
# this function take text as input and speak it with voice
...
#_>assistantResponse("My name is Lyanna and i am assistant of Rauf Odilov")


# create wake word function which activate program
...
def greeting(text):
    ...
    return ''
#_>print(greeting("hello my dear assistant"))


# a function to get information about person eg. first and last name
...
#finally we are in main part to activate program
while True:
    # Record the audio
    text = recordAudio()
